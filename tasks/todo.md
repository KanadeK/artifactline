...
- [ ] Add package metadata, immutable models, and workflow discovery.
...
- [ ] Parse jobs, transitive inputs, needs, static matrix axis names, action inputs, and source lines.
...
- [ ] Build artifact producer/consumer graph and implement `AFL001` to `AFL004`.
...
- [ ] Add terminal, JSON, SARIF, output files, strict mode, and stable exit codes.
...
- [ ] Add README, troubleshooting, CI, composite action, release workflow, changelog, and gate script.
...
- [ ] Review all changes across correctness, simplicity, architecture, security, and performance.
